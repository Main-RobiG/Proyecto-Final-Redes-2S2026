...
Se instaló el rol AD DS y se promovió el servidor como controlador de dominio para `servidor1.com`, con DNS integrado.
...
Se crearon las cuentas `usuario1` y `usuario2` dentro del dominio, ambas con su UserPrincipalName correspondiente.

![Listado de usuarios del dominio con UPN](./images/05-get-adusers.png)
